...
<head>
  <?php
    $hd_titulo="Anular Facturas ".$dse['nombre'];
              ...
              <div class="col s12 m12 l6">
                <table id="example" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                    $sw=true;
                    foreach($vfactura->mostrarTodo("idsede=$idsede") as $f)
                    {
                          ...
                          switch ($f['estado']) {
                            case '1':
                              ?>
                                ...
                                <button onclick="anular('<?php echo $f['idvfactura'] ?>');" target="_blank" class="btn-jh red"><i class="fa fa-times"></i> Anular</button>
                              <?php
                            break;
                            case '2':
